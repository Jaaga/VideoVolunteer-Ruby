...
module Arrays
  ...
  def date_set()
    ...
    return { story_dates: story_dates, footage_dates: footage_dates, status_dates: status_dates, impact_dates: impact_dates, extra_dates: extra_dates }
  end
  ...
  def extra_set()
    ...
    return { yes_no_impact: yes_no_impact, yes_no_screening: yes_no_screening, ratings: ratings, numbers_impact: numbers_impact, numbers_screening: numbers_screening }
  end
end
